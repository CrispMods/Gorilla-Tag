...
namespace com.AnotherAxiom.SpaceFight
{
	...
	{
		// Token: 0x06004717 RID: 18199 RVA: 0x001872A0 File Offset: 0x001854A0
		private void Update()
		{
			for (int i = 0; i < 2; i++)
			{
		...
		// Token: 0x06004718 RID: 18200 RVA: 0x00187430 File Offset: 0x00185630
		...
		// Token: 0x06004719 RID: 18201 RVA: 0x0005D78C File Offset: 0x0005B98C
		...
		// Token: 0x0600471A RID: 18202 RVA: 0x0005D7B1 File Offset: 0x0005B9B1
		private void move(Transform p, float speed)
		{
			p.Translate(p.up * Time.deltaTime * speed, Space.World);
		}

		// Token: 0x0600471B RID: 18203 RVA: 0x0005D7D0 File Offset: 0x0005B9D0
		private void turn(Transform p, bool cw)
		{
			p.Rotate(0f, 0f, (float)(cw ? 180 : -180) * Time.deltaTime);
		}

		// Token: 0x0600471C RID: 18204 RVA: 0x0018749C File Offset: 0x0018569C
		...
		// Token: 0x0600471D RID: 18205 RVA: 0x0018761C File Offset: 0x0018581C
		...
		// Token: 0x0600471E RID: 18206 RVA: 0x0002F75F File Offset: 0x0002D95F
		protected override void ButtonUp(int player, ArcadeButtons button)
		{
		}

		// Token: 0x0600471F RID: 18207 RVA: 0x0002F75F File Offset: 0x0002D95F
		...
		{
			// Token: 0x06004721 RID: 18209 RVA: 0x00187708 File Offset: 0x00185908
