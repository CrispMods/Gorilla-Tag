...
public class GorillaVelocityEstimator : MonoBehaviour
{
	...
	// (get) Token: 0x060004FF RID: 1279 RVA: 0x00032BF2 File Offset: 0x00030DF2
	// (set) Token: 0x06000500 RID: 1280 RVA: 0x00032BFA File Offset: 0x00030DFA
	public Vector3 linearVelocity { get; private set; }

	// Token: 0x1700005F RID: 95
	// (get) Token: 0x06000501 RID: 1281 RVA: 0x00032C03 File Offset: 0x00030E03
	// (set) Token: 0x06000502 RID: 1282 RVA: 0x00032C0B File Offset: 0x00030E0B
	public Vector3 angularVelocity { get; private set; }

	// Token: 0x17000060 RID: 96
	// (get) Token: 0x06000503 RID: 1283 RVA: 0x00032C14 File Offset: 0x00030E14
	// (set) Token: 0x06000504 RID: 1284 RVA: 0x00032C1C File Offset: 0x00030E1C
	public Vector3 handPos { get; private set; }

	// Token: 0x06000505 RID: 1285 RVA: 0x00032C25 File Offset: 0x00030E25
	private void Awake()
	{
		this.history = new GorillaVelocityEstimator.VelocityHistorySample[this.numFrames];
	}

	// Token: 0x06000506 RID: 1286 RVA: 0x0007E558 File Offset: 0x0007C758
	...
	// Token: 0x06000507 RID: 1287 RVA: 0x00032C38 File Offset: 0x00030E38
	private void OnDisable()
	{
		GorillaVelocityEstimatorManager.Unregister(this);
	}

	// Token: 0x06000508 RID: 1288 RVA: 0x00032C38 File Offset: 0x00030E38
	private void OnDestroy()
	{
		GorillaVelocityEstimatorManager.Unregister(this);
	}

	// Token: 0x06000509 RID: 1289 RVA: 0x0007E5BC File Offset: 0x0007C7BC
