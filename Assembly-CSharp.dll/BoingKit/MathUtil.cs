...
namespace BoingKit
{
	...
	{
		// Token: 0x0600535F RID: 21343 RVA: 0x0006400E File Offset: 0x0006220E
		public static float AsinSafe(float x)
		{
			return Mathf.Asin(Mathf.Clamp(x, -1f, 1f));
		}

		// Token: 0x06005360 RID: 21344 RVA: 0x00064025 File Offset: 0x00062225
		public static float AcosSafe(float x)
		{
			return Mathf.Acos(Mathf.Clamp(x, -1f, 1f));
		}

		// Token: 0x06005361 RID: 21345 RVA: 0x0006559B File Offset: 0x0006379B
		public static float InvSafe(float x)
		{
			return 1f / Mathf.Max(MathUtil.Epsilon, x);
		}

		// Token: 0x06005362 RID: 21346 RVA: 0x001C7BC4 File Offset: 0x001C5DC4
		...
		// Token: 0x06005363 RID: 21347 RVA: 0x001C7BF4 File Offset: 0x001C5DF4
		...
		// Token: 0x06005364 RID: 21348 RVA: 0x001C7C5C File Offset: 0x001C5E5C
		...
		// Token: 0x06005365 RID: 21349 RVA: 0x001C7C84 File Offset: 0x001C5E84
		...
		// Token: 0x06005366 RID: 21350 RVA: 0x000655AE File Offset: 0x000637AE
		public static float Remainder(float a, float b)
		{
			return a - a / b * b;
		}

		// Token: 0x06005367 RID: 21351 RVA: 0x000655AE File Offset: 0x000637AE
		public static int Remainder(int a, int b)
		{
			return a - a / b * b;
		}

		// Token: 0x06005368 RID: 21352 RVA: 0x000655B7 File Offset: 0x000637B7
		public static float Modulo(float a, float b)
		{
			return Mathf.Repeat(a, b);
		}

		// Token: 0x06005369 RID: 21353 RVA: 0x001C7CC8 File Offset: 0x001C5EC8
