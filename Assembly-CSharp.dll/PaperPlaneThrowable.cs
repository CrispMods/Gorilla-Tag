...
{
	// Token: 0x06001AD0 RID: 6864 RVA: 0x000D5F10 File Offset: 0x000D4110
	...
	// Token: 0x06001AD1 RID: 6865 RVA: 0x0004137A File Offset: 0x0003F57A
	...
	// Token: 0x06001AD2 RID: 6866 RVA: 0x000413B5 File Offset: 0x0003F5B5
	...
	// Token: 0x06001AD3 RID: 6867 RVA: 0x000D5FE8 File Offset: 0x000D41E8
	private void OnPhotonEvent(EventData evData)
	{
		...
		if ((int)obj != PaperPlaneThrowable.kProjectileEvent)
		{
			return;
		}
		...
		Vector3 launchPos = (Vector3)array[2];
		...
		{
			Debug.Log("force niggering didnt pass");
			return;
		}
		if (!releaseVel.IsValid(num2))
		{
			Debug.Log("velocity is valid didnt pass");
			return;
		}
		Debug.Log("did pas-----------------------------------");
		this.LaunchProjectileLocal(launchPos, launchRot, releaseVel);
	...
	// Token: 0x06001AD4 RID: 6868 RVA: 0x000413D3 File Offset: 0x0003F5D3
	...
	// Token: 0x06001AD5 RID: 6869 RVA: 0x000413F2 File Offset: 0x0003F5F2
	...
	// Token: 0x06001AD6 RID: 6870 RVA: 0x000D6138 File Offset: 0x000D4338
	...
	// Token: 0x06001AD7 RID: 6871 RVA: 0x000D61D4 File Offset: 0x000D43D4
	...
	// Token: 0x06001AD8 RID: 6872 RVA: 0x000D6300 File Offset: 0x000D4500
	...
	// Token: 0x06001AD9 RID: 6873 RVA: 0x000D6344 File Offset: 0x000D4544
	private void LaunchProjectileLocal(Vector3 launchPos, Quaternion launchRot, Vector3 releaseVel)
	{
		...
		Debug.Log("tassyy whole");
	}

	// Token: 0x06001ADA RID: 6874 RVA: 0x0004140A File Offset: 0x0003F60A
	private void OnProjectileHit(Vector3 endPoint)
	{
		this._renderer.forceRenderingOff = false;
	}

	// Token: 0x06001ADB RID: 6875 RVA: 0x000D63F8 File Offset: 0x000D45F8
	...
	// Token: 0x06001ADC RID: 6876 RVA: 0x000D6460 File Offset: 0x000D4660
	...
	// Token: 0x06001ADD RID: 6877 RVA: 0x00041418 File Offset: 0x0003F618
