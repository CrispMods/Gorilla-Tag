...
{
	// Token: 0x0600141D RID: 5149 RVA: 0x0003C8F4 File Offset: 0x0003AAF4
	...
	// Token: 0x0600141E RID: 5150 RVA: 0x0003C904 File Offset: 0x0003AB04
	public void SetName(string name)
	{
		this.m_nameLabel.text = name;
	}

	// Token: 0x0600141F RID: 5151 RVA: 0x000B958C File Offset: 0x000B778C
