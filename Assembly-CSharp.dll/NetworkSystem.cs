...
public abstract class NetworkSystem : MonoBehaviour
{
	...
	// (get) Token: 0x06000F3E RID: 3902 RVA: 0x00039B5E File Offset: 0x00037D5E
	// (set) Token: 0x06000F3F RID: 3903 RVA: 0x00039B66 File Offset: 0x00037D66
	public bool groupJoinInProgress { get; protected set; }

	// Token: 0x1700019F RID: 415
	// (get) Token: 0x06000F40 RID: 3904 RVA: 0x00039B6F File Offset: 0x00037D6F
	// (set) Token: 0x06000F41 RID: 3905 RVA: 0x00039B77 File Offset: 0x00037D77
	...
	// (get) Token: 0x06000F42 RID: 3906 RVA: 0x00039B9C File Offset: 0x00037D9C
	...
	// (get) Token: 0x06000F43 RID: 3907 RVA: 0x00039BC8 File Offset: 0x00037DC8
	public virtual bool IsMasterClient { get; }

	// Token: 0x170001A2 RID: 418
	// (get) Token: 0x06000F44 RID: 3908 RVA: 0x00039BD0 File Offset: 0x00037DD0
	...
	// (get) Token: 0x06000F45 RID: 3909 RVA: 0x00039BFC File Offset: 0x00037DFC
	...
	// (get) Token: 0x06000F46 RID: 3910 RVA: 0x00039C04 File Offset: 0x00037E04
	// (set) Token: 0x06000F47 RID: 3911 RVA: 0x00039C0C File Offset: 0x00037E0C
	public virtual Speaker LocalSpeaker { get; set; }

	// Token: 0x14000028 RID: 40
	// (add) Token: 0x06000F48 RID: 3912 RVA: 0x000A5DB0 File Offset: 0x000A3FB0
	// (remove) Token: 0x06000F49 RID: 3913 RVA: 0x000A5DE8 File Offset: 0x000A3FE8
	public event Action OnJoinedRoomEvent;

	// Token: 0x06000F4A RID: 3914 RVA: 0x00039C15 File Offset: 0x00037E15
	...
	// (add) Token: 0x06000F4B RID: 3915 RVA: 0x000A5E20 File Offset: 0x000A4020
	// (remove) Token: 0x06000F4C RID: 3916 RVA: 0x000A5E58 File Offset: 0x000A4058
	public event Action OnMultiplayerStarted;

	// Token: 0x06000F4D RID: 3917 RVA: 0x00039C31 File Offset: 0x00037E31
	...
	// (add) Token: 0x06000F4E RID: 3918 RVA: 0x000A5E90 File Offset: 0x000A4090
	// (remove) Token: 0x06000F4F RID: 3919 RVA: 0x000A5EC8 File Offset: 0x000A40C8
	public event Action OnReturnedToSinglePlayer;

	// Token: 0x06000F50 RID: 3920 RVA: 0x000A5F00 File Offset: 0x000A4100
	...
	// (add) Token: 0x06000F51 RID: 3921 RVA: 0x000A5F44 File Offset: 0x000A4144
	// (remove) Token: 0x06000F52 RID: 3922 RVA: 0x000A5F7C File Offset: 0x000A417C
	public event Action<NetPlayer> OnPlayerJoined;

	// Token: 0x06000F53 RID: 3923 RVA: 0x00039C43 File Offset: 0x00037E43
	...
	// (add) Token: 0x06000F54 RID: 3924 RVA: 0x000A5FB4 File Offset: 0x000A41B4
	// (remove) Token: 0x06000F55 RID: 3925 RVA: 0x000A5FEC File Offset: 0x000A41EC
	public event Action<NetPlayer> OnPlayerLeft;

	// Token: 0x06000F56 RID: 3926 RVA: 0x000A6024 File Offset: 0x000A4224
	...
	// (add) Token: 0x06000F57 RID: 3927 RVA: 0x000A6068 File Offset: 0x000A4268
	// (remove) Token: 0x06000F58 RID: 3928 RVA: 0x000A60A0 File Offset: 0x000A42A0
	internal event Action<NetPlayer> OnMasterClientSwitchedEvent;

	// Token: 0x06000F59 RID: 3929 RVA: 0x00039C69 File Offset: 0x00037E69
	...
	// (add) Token: 0x06000F5A RID: 3930 RVA: 0x000A60D8 File Offset: 0x000A42D8
	// (remove) Token: 0x06000F5B RID: 3931 RVA: 0x000A6110 File Offset: 0x000A4310
	public event Action<byte, object, int> OnRaiseEvent;

	// Token: 0x06000F5C RID: 3932 RVA: 0x00039C7C File Offset: 0x00037E7C
	...
	// (add) Token: 0x06000F5D RID: 3933 RVA: 0x000A6148 File Offset: 0x000A4348
	// (remove) Token: 0x06000F5E RID: 3934 RVA: 0x000A6180 File Offset: 0x000A4380
	public event Action<Dictionary<string, object>> OnCustomAuthenticationResponse;

	// Token: 0x06000F5F RID: 3935 RVA: 0x00039C91 File Offset: 0x00037E91
	...
	// Token: 0x06000F60 RID: 3936 RVA: 0x00039CA4 File Offset: 0x00037EA4
	...
	// Token: 0x06000F61 RID: 3937 RVA: 0x0002F75F File Offset: 0x0002D95F
	protected virtual void Update()
	{
	}

	// Token: 0x06000F62 RID: 3938 RVA: 0x00039CD3 File Offset: 0x00037ED3
	...
	// Token: 0x06000F63 RID: 3939 RVA: 0x00039CEF File Offset: 0x00037EEF
	public virtual void AttachObjectInGame(GameObject item)
	{
		this.RegisterSceneNetworkItem(item);
	}

	// Token: 0x06000F64 RID: 3940 RVA: 0x0002F75F File Offset: 0x0002D95F
	public virtual void DetatchSceneObjectInGame(GameObject item)
	{
	}

	// Token: 0x06000F65 RID: 3941 RVA: 0x00039CF8 File Offset: 0x00037EF8
	...
	// Token: 0x06000F66 RID: 3942 RVA: 0x00039D09 File Offset: 0x00037F09
	...
	// (get) Token: 0x06000F6C RID: 3948 RVA: 0x00039D15 File Offset: 0x00037F15
	...
	// Token: 0x06000F6D RID: 3949 RVA: 0x00039D1D File Offset: 0x00037F1D
	public void SetWrongVersion()
	{
		this.isWrongVersion = true;
	}

	// Token: 0x06000F6E RID: 3950 RVA: 0x00039D26 File Offset: 0x00037F26
	...
	// Token: 0x06000F6F RID: 3951 RVA: 0x00039D3A File Offset: 0x00037F3A
	...
	// Token: 0x06000F7B RID: 3963 RVA: 0x000A61B8 File Offset: 0x000A43B8
	...
	// Token: 0x06000F7D RID: 3965 RVA: 0x000A6230 File Offset: 0x000A4430
	...
	// Token: 0x06000F7E RID: 3966 RVA: 0x000A6274 File Offset: 0x000A4474
	...
	// Token: 0x06000F7F RID: 3967 RVA: 0x00039D4A File Offset: 0x00037F4A
	private void GetSteamAuthTicketFailureCallback(EResult result)
	{
		base.StartCoroutine(this.ReGetNonce());
	}

	// Token: 0x06000F80 RID: 3968 RVA: 0x00039D59 File Offset: 0x00037F59
	...
	// Token: 0x06000F81 RID: 3969 RVA: 0x000A62C0 File Offset: 0x000A44C0
	...
	// Token: 0x06000F82 RID: 3970 RVA: 0x000A63D8 File Offset: 0x000A45D8
	...
	// Token: 0x06000F83 RID: 3971 RVA: 0x000A6448 File Offset: 0x000A4648
	...
	// Token: 0x06000F89 RID: 3977 RVA: 0x00033163 File Offset: 0x00031363
	...
	// Token: 0x06000F8E RID: 3982 RVA: 0x000A6524 File Offset: 0x000A4724
	...
	// Token: 0x06000F8F RID: 3983 RVA: 0x000A6578 File Offset: 0x000A4778
	...
	// Token: 0x06000F90 RID: 3984 RVA: 0x00037F8B File Offset: 0x0003618B
	...
	// Token: 0x06000F9C RID: 3996 RVA: 0x00039D68 File Offset: 0x00037F68
	...
	// Token: 0x06000FA3 RID: 4003 RVA: 0x000A65C0 File Offset: 0x000A47C0
	...
	// (get) Token: 0x06000FA8 RID: 4008 RVA: 0x00039D71 File Offset: 0x00037F71
	...
	// (get) Token: 0x06000FA9 RID: 4009 RVA: 0x00039D7E File Offset: 0x00037F7E
	...
	// Token: 0x06000FAB RID: 4011 RVA: 0x00039DAF File Offset: 0x00037FAF
	...
	// (get) Token: 0x06000FB3 RID: 4019 RVA: 0x00039DB7 File Offset: 0x00037FB7
	// (set) Token: 0x06000FB4 RID: 4020 RVA: 0x00039DBF File Offset: 0x00037FBF
