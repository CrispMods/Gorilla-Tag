...
{
	// Token: 0x06001A8D RID: 6797 RVA: 0x00040FDC File Offset: 0x0003F1DC
	...
	// Token: 0x06001A8E RID: 6798 RVA: 0x00041016 File Offset: 0x0003F216
	...
	// Token: 0x06001A8F RID: 6799 RVA: 0x00041050 File Offset: 0x0003F250
	public void OnBiteView(VRRig rig, int nextState)
	{
		this.OnBite(rig, nextState, true);
	}

	// Token: 0x06001A90 RID: 6800 RVA: 0x0004105B File Offset: 0x0003F25B
	public void OnBiteWorld(VRRig rig, int nextState)
	{
		this.OnBite(rig, nextState, false);
	}

	// Token: 0x06001A91 RID: 6801 RVA: 0x000D53D0 File Offset: 0x000D35D0
