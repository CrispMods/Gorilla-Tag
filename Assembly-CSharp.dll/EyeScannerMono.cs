...
public class EyeScannerMono : MonoBehaviour, ISpawnable, IGorillaSliceableSimple
{
	...
	// (get) Token: 0x06000384 RID: 900 RVA: 0x00031BB4 File Offset: 0x0002FDB4
	// (set) Token: 0x06000385 RID: 901 RVA: 0x00077710 File Offset: 0x00075910
	...
	// (get) Token: 0x06000386 RID: 902 RVA: 0x00031BBC File Offset: 0x0002FDBC
	...
	// Token: 0x06000387 RID: 903 RVA: 0x00031BC3 File Offset: 0x0002FDC3
	...
	// Token: 0x06000388 RID: 904 RVA: 0x00031BE2 File Offset: 0x0002FDE2
	...
	// Token: 0x06000389 RID: 905 RVA: 0x00077760 File Offset: 0x00075960
	...
	// (get) Token: 0x0600038A RID: 906 RVA: 0x00031C02 File Offset: 0x0002FE02
	// (set) Token: 0x0600038B RID: 907 RVA: 0x00031C0A File Offset: 0x0002FE0A
	bool ISpawnable.IsSpawned { get; set; }

	// Token: 0x17000038 RID: 56
	// (get) Token: 0x0600038C RID: 908 RVA: 0x00031C13 File Offset: 0x0002FE13
	// (set) Token: 0x0600038D RID: 909 RVA: 0x00031C1B File Offset: 0x0002FE1B
	ECosmeticSelectSide ISpawnable.CosmeticSelectedSide { get; set; }

	// Token: 0x17000039 RID: 57
	// (get) Token: 0x0600038E RID: 910 RVA: 0x00031C24 File Offset: 0x0002FE24
	// (set) Token: 0x0600038F RID: 911 RVA: 0x00031C2C File Offset: 0x0002FE2C
	public string DebugData { get; private set; }

	// Token: 0x06000390 RID: 912 RVA: 0x000777FC File Offset: 0x000759FC
	...
	// Token: 0x06000391 RID: 913 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnDespawn()
	{
	}

	// Token: 0x06000392 RID: 914 RVA: 0x00030F55 File Offset: 0x0002F155
	public void OnEnable()
	{
		GorillaSlicerSimpleManager.RegisterSliceable(this, GorillaSlicerSimpleManager.UpdateStep.LateUpdate);
	}

	// Token: 0x06000393 RID: 915 RVA: 0x00030F5E File Offset: 0x0002F15E
	public void OnDisable()
	{
		GorillaSlicerSimpleManager.UnregisterSliceable(this, GorillaSlicerSimpleManager.UpdateStep.LateUpdate);
	}

	// Token: 0x06000394 RID: 916 RVA: 0x00077850 File Offset: 0x00075A50
	...
	// Token: 0x06000395 RID: 917 RVA: 0x00031C35 File Offset: 0x0002FE35
	private void Scannable_OnDataChange()
	{
		this._OnScannableChanged(this._oldClosestScannable, false);
	}

	// Token: 0x06000396 RID: 918 RVA: 0x0007798C File Offset: 0x00075B8C
	...
	// Token: 0x06000397 RID: 919 RVA: 0x00077AB8 File Offset: 0x00075CB8
	...
	// Token: 0x0600039A RID: 922 RVA: 0x00030F9B File Offset: 0x0002F19B
