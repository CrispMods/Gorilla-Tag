...
{
	// Token: 0x06001CE2 RID: 7394 RVA: 0x00042C65 File Offset: 0x00040E65
	public void Setup(MonkeBallGame game)
	{
		this.game = game;
	}

	// Token: 0x06001CE3 RID: 7395 RVA: 0x000DD608 File Offset: 0x000DB808
	...
	// Token: 0x06001CE4 RID: 7396 RVA: 0x00042C6E File Offset: 0x00040E6E
	...
	// Token: 0x06001CE5 RID: 7397 RVA: 0x00042C9A File Offset: 0x00040E9A
	public void PlayScoreFx()
	{
		this.PlayFX(this.scoreSound, this.scoreSoundVolume);
	}

	// Token: 0x06001CE6 RID: 7398 RVA: 0x00042CAE File Offset: 0x00040EAE
	public void PlayPlayerJoinFx()
	{
		this.PlayFX(this.playerJoinSound, 0.5f);
	}

	// Token: 0x06001CE7 RID: 7399 RVA: 0x00042CC1 File Offset: 0x00040EC1
	public void PlayPlayerLeaveFx()
	{
		this.PlayFX(this.playerLeaveSound, 0.5f);
	}

	// Token: 0x06001CE8 RID: 7400 RVA: 0x00042CD4 File Offset: 0x00040ED4
	public void PlayGameStartFx()
	{
		this.PlayFX(this.gameStartSound, this.gameStartVolume);
	}

	// Token: 0x06001CE9 RID: 7401 RVA: 0x00042CE8 File Offset: 0x00040EE8
	public void PlayGameEndFx()
	{
		this.PlayFX(this.gameEndSound, this.gameEndVolume);
	}

	// Token: 0x06001CEA RID: 7402 RVA: 0x00042CFC File Offset: 0x00040EFC
	...
	// Token: 0x06001CEB RID: 7403 RVA: 0x000DD660 File Offset: 0x000DB860
