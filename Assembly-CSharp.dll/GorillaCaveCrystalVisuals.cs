...
public class GorillaCaveCrystalVisuals : MonoBehaviour
{
	...
	// (get) Token: 0x0600214F RID: 8527 RVA: 0x00045B3A File Offset: 0x00043D3A
	// (set) Token: 0x06002150 RID: 8528 RVA: 0x00045B42 File Offset: 0x00043D42
	public float lerp
	{
		get
		{
	...
	// Token: 0x06002151 RID: 8529 RVA: 0x000F356C File Offset: 0x000F176C
	public void Setup()
	{
	...
	// Token: 0x06002152 RID: 8530 RVA: 0x00045B4B File Offset: 0x00043D4B
	private void Start()
	{
		this.UpdateAlbedo();
		this.ForceUpdate();
	...
	// Token: 0x06002153 RID: 8531 RVA: 0x000F35E8 File Offset: 0x000F17E8
	...
	// Token: 0x06002154 RID: 8532 RVA: 0x00045B59 File Offset: 0x00043D59
	private void Awake()
	{
		this.UpdateAlbedo();
		this.Update();
	...
	// Token: 0x06002155 RID: 8533 RVA: 0x000F3660 File Offset: 0x000F1860
	private void Update()
	{
		if (!this._initialized)
		{
	...
	// Token: 0x06002156 RID: 8534 RVA: 0x00045B67 File Offset: 0x00043D67
	...
	// Token: 0x06002157 RID: 8535 RVA: 0x000F3758 File Offset: 0x000F1958
