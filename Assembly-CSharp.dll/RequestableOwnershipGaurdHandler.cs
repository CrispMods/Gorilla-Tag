...
{
	// Token: 0x06000B6A RID: 2922 RVA: 0x00037201 File Offset: 0x00035401
	static RequestableOwnershipGaurdHandler()
	{
		PhotonNetwork.AddCallbackTarget(RequestableOwnershipGaurdHandler.callbackInstance);
	}

	// Token: 0x06000B6B RID: 2923 RVA: 0x0003722B File Offset: 0x0003542B
	...
	// Token: 0x06000B6C RID: 2924 RVA: 0x0003725C File Offset: 0x0003545C
	...
	// Token: 0x06000B6D RID: 2925 RVA: 0x000995A8 File Offset: 0x000977A8
	...
	// Token: 0x06000B6E RID: 2926 RVA: 0x000995D0 File Offset: 0x000977D0
	...
	// Token: 0x06000B6F RID: 2927 RVA: 0x000995F8 File Offset: 0x000977F8
	void IPunOwnershipCallbacks.OnOwnershipTransfered(PhotonView targetView, Player previousOwner)
	{
		...
		if (!object.Equals(previousOwner, requestableOwnershipGuard.currentOwner))
		{
			...
			int num = (currentOwner != null) ? currentOwner.ActorNumber : 0;
			targetView.OwnerActorNr = num;
			targetView.ControllerActorNr = num;
		}
	}

	// Token: 0x06000B70 RID: 2928 RVA: 0x00099688 File Offset: 0x00097888
	...
	// Token: 0x06000B71 RID: 2929 RVA: 0x00037280 File Offset: 0x00035480
	void IInRoomCallbacks.OnMasterClientSwitched(Player newMasterClient)
	{
		this.OnHostChangedShared();
	}

	// Token: 0x06000B72 RID: 2930 RVA: 0x00037280 File Offset: 0x00035480
	public void OnHostMigration(NetworkRunner runner, HostMigrationToken hostMigrationToken)
	{
		this.OnHostChangedShared();
	}

	// Token: 0x06000B73 RID: 2931 RVA: 0x00099700 File Offset: 0x00097900
	...
	// Token: 0x06000B74 RID: 2932 RVA: 0x0002F75F File Offset: 0x0002D95F
	void IPunOwnershipCallbacks.OnOwnershipRequest(PhotonView targetView, Player requestingPlayer)
	{
	}

	// Token: 0x06000B75 RID: 2933 RVA: 0x0002F75F File Offset: 0x0002D95F
	void IPunOwnershipCallbacks.OnOwnershipTransferFailed(PhotonView targetView, Player senderOfFailedRequest)
	{
	}

	// Token: 0x06000B76 RID: 2934 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnPlayerEnteredRoom(Player newPlayer)
	{
	}

	// Token: 0x06000B77 RID: 2935 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnPlayerLeftRoom(Player otherPlayer)
	{
	}

	// Token: 0x06000B78 RID: 2936 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnRoomPropertiesUpdate(Hashtable propertiesThatChanged)
	{
	}

	// Token: 0x06000B79 RID: 2937 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnPlayerPropertiesUpdate(Player targetPlayer, Hashtable changedProps)
	{
	}

	// Token: 0x06000B7A RID: 2938 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnObjectExitAOI(NetworkRunner runner, NetworkObject obj, PlayerRef player)
	{
	}

	// Token: 0x06000B7B RID: 2939 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnObjectEnterAOI(NetworkRunner runner, NetworkObject obj, PlayerRef player)
	{
	}

	// Token: 0x06000B7C RID: 2940 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnPlayerJoined(NetworkRunner runner, PlayerRef player)
	{
	}

	// Token: 0x06000B7D RID: 2941 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnPlayerLeft(NetworkRunner runner, PlayerRef player)
	{
	}

	// Token: 0x06000B7E RID: 2942 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnInput(NetworkRunner runner, NetworkInput input)
	{
	}

	// Token: 0x06000B7F RID: 2943 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnInputMissing(NetworkRunner runner, PlayerRef player, NetworkInput input)
	{
	}

	// Token: 0x06000B80 RID: 2944 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnShutdown(NetworkRunner runner, ShutdownReason shutdownReason)
	{
	}

	// Token: 0x06000B81 RID: 2945 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnConnectedToServer(NetworkRunner runner)
	{
	}

	// Token: 0x06000B82 RID: 2946 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnDisconnectedFromServer(NetworkRunner runner, NetDisconnectReason reason)
	{
	}

	// Token: 0x06000B83 RID: 2947 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnConnectRequest(NetworkRunner runner, NetworkRunnerCallbackArgs.ConnectRequest request, byte[] token)
	{
	}

	// Token: 0x06000B84 RID: 2948 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnConnectFailed(NetworkRunner runner, NetAddress remoteAddress, NetConnectFailedReason reason)
	{
	}

	// Token: 0x06000B85 RID: 2949 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnUserSimulationMessage(NetworkRunner runner, SimulationMessagePtr message)
	{
	}

	// Token: 0x06000B86 RID: 2950 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnSessionListUpdated(NetworkRunner runner, List<SessionInfo> sessionList)
	{
	}

	// Token: 0x06000B87 RID: 2951 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnCustomAuthenticationResponse(NetworkRunner runner, Dictionary<string, object> data)
	{
	}

	// Token: 0x06000B88 RID: 2952 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnReliableDataReceived(NetworkRunner runner, PlayerRef player, ReliableKey key, ArraySegment<byte> data)
	{
	}

	// Token: 0x06000B89 RID: 2953 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnReliableDataProgress(NetworkRunner runner, PlayerRef player, ReliableKey key, float progress)
	{
	}

	// Token: 0x06000B8A RID: 2954 RVA: 0x0002F75F File Offset: 0x0002D95F
	public void OnSceneLoadDone(NetworkRunner runner)
	{
	}

	// Token: 0x06000B8B RID: 2955 RVA: 0x0002F75F File Offset: 0x0002D95F
