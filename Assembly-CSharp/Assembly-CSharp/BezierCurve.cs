...
{
	// Token: 0x06003478 RID: 13432 RVA: 0x000FA658 File Offset: 0x000F8858
	public Vector3 GetPoint(float t)
	{
		return base.transform.TransformPoint(Bezier.GetPoint(this.points[0], this.points[1], this.points[2], this.points[3], t));
	}

	// Token: 0x06003479 RID: 13433 RVA: 0x000FA6A8 File Offset: 0x000F88A8
	...
	// Token: 0x0600347A RID: 13434 RVA: 0x000FA708 File Offset: 0x000F8908
	public Vector3 GetDirection(float t)
	{
		return this.GetVelocity(t).normalized;
	}

	// Token: 0x0600347B RID: 13435 RVA: 0x000FA724 File Offset: 0x000F8924
	public void Reset()
	{
