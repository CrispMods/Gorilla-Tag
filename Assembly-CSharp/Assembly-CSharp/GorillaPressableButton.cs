...
public class GorillaPressableButton : MonoBehaviour
{
	...
	// (add) Token: 0x060028AA RID: 10410 RVA: 0x000C80BC File Offset: 0x000C62BC
	// (remove) Token: 0x060028AB RID: 10411 RVA: 0x000C80F4 File Offset: 0x000C62F4
	public event Action<GorillaPressableButton, bool> onPressed;

	// Token: 0x060028AC RID: 10412 RVA: 0x000023F4 File Offset: 0x000005F4
	public virtual void Start()
	{
	}

	// Token: 0x060028AD RID: 10413 RVA: 0x000023F4 File Offset: 0x000005F4
	private void OnEnable()
	{
	}

	// Token: 0x060028AE RID: 10414 RVA: 0x000023F4 File Offset: 0x000005F4
	private void OnDisable()
	{
	}

	// Token: 0x060028AF RID: 10415 RVA: 0x000C812C File Offset: 0x000C632C
	...
	// Token: 0x060028B0 RID: 10416 RVA: 0x000C8268 File Offset: 0x000C6468
	...
	// Token: 0x060028B2 RID: 10418 RVA: 0x000023F4 File Offset: 0x000005F4
	public virtual void ButtonActivationWithHand(bool isLeftHand)
	{
	}

	// Token: 0x060028B3 RID: 10419 RVA: 0x000C835F File Offset: 0x000C655F
