...
{
	// Token: 0x0600253F RID: 9535 RVA: 0x000B8B90 File Offset: 0x000B6D90
	public float InitTimeOffset()
	{
		return this.startPercentage * this.cycleLength;
	}

	// Token: 0x06002540 RID: 9536 RVA: 0x000B8B9F File Offset: 0x000B6D9F
	private long InitTimeOffsetMs()
	{
		return (long)(this.InitTimeOffset() * 1000f);
	}

	// Token: 0x06002541 RID: 9537 RVA: 0x000B8BAE File Offset: 0x000B6DAE
	...
	// Token: 0x06002542 RID: 9538 RVA: 0x000B8BD7 File Offset: 0x000B6DD7
	private long CycleLengthMs()
	{
		return (long)(this.cycleLength * 1000f);
	}

	// Token: 0x06002543 RID: 9539 RVA: 0x000B8BE8 File Offset: 0x000B6DE8
	...
	// Token: 0x06002544 RID: 9540 RVA: 0x000B8C13 File Offset: 0x000B6E13
	public int CycleCount()
	{
		return (int)(this.NetworkTimeMs() / this.CycleLengthMs());
	}

	// Token: 0x06002545 RID: 9541 RVA: 0x000B8C24 File Offset: 0x000B6E24
	...
	// Token: 0x06002546 RID: 9542 RVA: 0x000B8C86 File Offset: 0x000B6E86
	public bool CycleForward()
	{
		return (this.CycleCount() + (this.startNextCycle ? 1 : 0)) % 2 == 0;
	}

	// Token: 0x06002547 RID: 9543 RVA: 0x000B8CA0 File Offset: 0x000B6EA0
	private void Awake()
	{
	...
	// Token: 0x06002548 RID: 9544 RVA: 0x000B8D70 File Offset: 0x000B6F70
	...
	// Token: 0x06002549 RID: 9545 RVA: 0x000B8DF9 File Offset: 0x000B6FF9
	private Vector3 UpdatePointToPoint()
	{
		return Vector3.Lerp(this.startPos, this.endPos, this.smoothedPercent);
	}

	// Token: 0x0600254A RID: 9546 RVA: 0x000B8E14 File Offset: 0x000B7014
	...
	// Token: 0x0600254B RID: 9547 RVA: 0x000B8E72 File Offset: 0x000B7072
	private Quaternion UpdateRotation()
	{
		return Quaternion.Slerp(this.startRot, this.endRot, this.smoothedPercent);
	}

	// Token: 0x0600254C RID: 9548 RVA: 0x000B8E8B File Offset: 0x000B708B
	...
	// Token: 0x0600254D RID: 9549 RVA: 0x000B8EB8 File Offset: 0x000B70B8
	...
	// Token: 0x0600254E RID: 9550 RVA: 0x000B8F88 File Offset: 0x000B7188
	private void Update()
	{
		if (this.platformType == MovingPlatform.PlatformType.Child)
		{
	...
	// Token: 0x0600254F RID: 9551 RVA: 0x000B90A9 File Offset: 0x000B72A9
