...
{
	// Token: 0x06000A95 RID: 2709 RVA: 0x00039943 File Offset: 0x00037B43
	private void Awake()
	{
		this.joinTriggerRef.TryResolve<GorillaNetworkJoinTrigger>(out this.joinTrigger);
	}

	// Token: 0x06000A96 RID: 2710 RVA: 0x00039957 File Offset: 0x00037B57
	private void Start()
	{
		this.didStart = true;
		this.OnEnable();
	...
	// Token: 0x06000A97 RID: 2711 RVA: 0x00039966 File Offset: 0x00037B66
	...
	// Token: 0x06000A98 RID: 2712 RVA: 0x0003997C File Offset: 0x00037B7C
	private void OnDisable()
	{
		this.joinTrigger.UnregisterUI(this);
	}

	// Token: 0x06000A99 RID: 2713 RVA: 0x0003998C File Offset: 0x00037B8C
