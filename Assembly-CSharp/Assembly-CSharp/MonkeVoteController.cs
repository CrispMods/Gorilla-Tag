...
public class MonkeVoteController : MonoBehaviour, IGorillaSliceableSimple
{
	...
	// (get) Token: 0x0600069D RID: 1693 RVA: 0x0002698A File Offset: 0x00024B8A
	// (set) Token: 0x0600069E RID: 1694 RVA: 0x00026991 File Offset: 0x00024B91
	public static MonkeVoteController instance { get; private set; }

	// Token: 0x1400000D RID: 13
	// (add) Token: 0x0600069F RID: 1695 RVA: 0x0002699C File Offset: 0x00024B9C
	// (remove) Token: 0x060006A0 RID: 1696 RVA: 0x000269D4 File Offset: 0x00024BD4
	public event Action OnPollsUpdated;

	// Token: 0x1400000E RID: 14
	// (add) Token: 0x060006A1 RID: 1697 RVA: 0x00026A0C File Offset: 0x00024C0C
	// (remove) Token: 0x060006A2 RID: 1698 RVA: 0x00026A44 File Offset: 0x00024C44
	public event Action OnVoteAccepted;

	// Token: 0x1400000F RID: 15
	// (add) Token: 0x060006A3 RID: 1699 RVA: 0x00026A7C File Offset: 0x00024C7C
	// (remove) Token: 0x060006A4 RID: 1700 RVA: 0x00026AB4 File Offset: 0x00024CB4
	public event Action OnVoteFailed;

	// Token: 0x14000010 RID: 16
	// (add) Token: 0x060006A5 RID: 1701 RVA: 0x00026AEC File Offset: 0x00024CEC
	// (remove) Token: 0x060006A6 RID: 1702 RVA: 0x00026B24 File Offset: 0x00024D24
	public event Action OnCurrentPollEnded;

	// Token: 0x060006A7 RID: 1703 RVA: 0x00026B59 File Offset: 0x00024D59
	public void Awake()
	{
	...
	// Token: 0x060006A8 RID: 1704 RVA: 0x00026B78 File Offset: 0x00024D78
	...
	// Token: 0x060006A9 RID: 1705 RVA: 0x00015C1D File Offset: 0x00013E1D
	public void OnEnable()
	{
		GorillaSlicerSimpleManager.RegisterSliceable(this, GorillaSlicerSimpleManager.UpdateStep.Update);
	}

	// Token: 0x060006AA RID: 1706 RVA: 0x00015C26 File Offset: 0x00013E26
	public void OnDisable()
	{
		GorillaSlicerSimpleManager.UnregisterSliceable(this, GorillaSlicerSimpleManager.UpdateStep.Update);
	}

	// Token: 0x060006AB RID: 1707 RVA: 0x00026BCC File Offset: 0x00024DCC
	...
	// Token: 0x060006AC RID: 1708 RVA: 0x00026C04 File Offset: 0x00024E04
	...
	// Token: 0x060006AD RID: 1709 RVA: 0x00026C40 File Offset: 0x00024E40
	...
	// Token: 0x060006AE RID: 1710 RVA: 0x00026CA6 File Offset: 0x00024EA6
	...
	// Token: 0x060006AF RID: 1711 RVA: 0x00026CC4 File Offset: 0x00024EC4
	...
	// Token: 0x060006B0 RID: 1712 RVA: 0x00026DF8 File Offset: 0x00024FF8
	...
	// Token: 0x060006B1 RID: 1713 RVA: 0x00026E2E File Offset: 0x0002502E
	private void SendVote()
	{
		this.GetNonceForVotingCallback(null);
	}

	// Token: 0x060006B2 RID: 1714 RVA: 0x00026E38 File Offset: 0x00025038
	...
	// Token: 0x060006B3 RID: 1715 RVA: 0x00026F06 File Offset: 0x00025106
	...
	// Token: 0x060006B4 RID: 1716 RVA: 0x00026F23 File Offset: 0x00025123
	...
	// Token: 0x060006B5 RID: 1717 RVA: 0x00026F57 File Offset: 0x00025157
	public MonkeVoteController.FetchPollsResponse GetLastPollData()
	{
		return this.lastPollData;
	}

	// Token: 0x060006B6 RID: 1718 RVA: 0x00026F5F File Offset: 0x0002515F
	public MonkeVoteController.FetchPollsResponse GetCurrentPollData()
	{
		return this.currentPollData;
	}

	// Token: 0x060006B7 RID: 1719 RVA: 0x00026F67 File Offset: 0x00025167
	public MonkeVoteController.VoteResponse GetVoteData()
	{
		return this.lastVoteData;
	}

	// Token: 0x060006B8 RID: 1720 RVA: 0x00026F6F File Offset: 0x0002516F
	public int GetLastVotePollId()
	{
		return this.pollId;
	}

	// Token: 0x060006B9 RID: 1721 RVA: 0x00026F77 File Offset: 0x00025177
	public int GetLastVoteSelectedOption()
	{
		return this.option;
	}

	// Token: 0x060006BA RID: 1722 RVA: 0x00026F7F File Offset: 0x0002517F
	public bool GetLastVoteWasPrediction()
	{
		return this.isPrediction;
	}

	// Token: 0x060006BB RID: 1723 RVA: 0x00026F87 File Offset: 0x00025187
	public DateTime GetCurrentPollCompletionTime()
	{
		return this.currentPollCompletionTime;
	}

	// Token: 0x060006BD RID: 1725 RVA: 0x0000FD18 File Offset: 0x0000DF18
	...
	public class VoteResponse
	{
		...
		// (get) Token: 0x060006C1 RID: 1729 RVA: 0x00026FB7 File Offset: 0x000251B7
		// (set) Token: 0x060006C2 RID: 1730 RVA: 0x00026FBF File Offset: 0x000251BF
		public int PollId { get; set; }

		// Token: 0x170000A2 RID: 162
		// (get) Token: 0x060006C3 RID: 1731 RVA: 0x00026FC8 File Offset: 0x000251C8
		// (set) Token: 0x060006C4 RID: 1732 RVA: 0x00026FD0 File Offset: 0x000251D0
		public string TitleId { get; set; }

		// Token: 0x170000A3 RID: 163
		// (get) Token: 0x060006C5 RID: 1733 RVA: 0x00026FD9 File Offset: 0x000251D9
		// (set) Token: 0x060006C6 RID: 1734 RVA: 0x00026FE1 File Offset: 0x000251E1
		public List<string> VoteOptions { get; set; }

		// Token: 0x170000A4 RID: 164
		// (get) Token: 0x060006C7 RID: 1735 RVA: 0x00026FEA File Offset: 0x000251EA
		// (set) Token: 0x060006C8 RID: 1736 RVA: 0x00026FF2 File Offset: 0x000251F2
		public List<int> VoteCount { get; set; }

		// Token: 0x170000A5 RID: 165
		// (get) Token: 0x060006C9 RID: 1737 RVA: 0x00026FFB File Offset: 0x000251FB
		// (set) Token: 0x060006CA RID: 1738 RVA: 0x00027003 File Offset: 0x00025203
