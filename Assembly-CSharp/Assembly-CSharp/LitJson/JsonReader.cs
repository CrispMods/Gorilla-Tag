...
namespace LitJson
{
	...
	public class JsonReader
	{
		...
		// (get) Token: 0x06003A14 RID: 14868 RVA: 0x0010B46C File Offset: 0x0010966C
		// (set) Token: 0x06003A15 RID: 14869 RVA: 0x0010B479 File Offset: 0x00109679
		...
		// (get) Token: 0x06003A16 RID: 14870 RVA: 0x0010B487 File Offset: 0x00109687
		// (set) Token: 0x06003A17 RID: 14871 RVA: 0x0010B494 File Offset: 0x00109694
		...
		// (get) Token: 0x06003A18 RID: 14872 RVA: 0x0010B4A2 File Offset: 0x001096A2
		...
		// (get) Token: 0x06003A19 RID: 14873 RVA: 0x0010B4AA File Offset: 0x001096AA
		...
		// (get) Token: 0x06003A1A RID: 14874 RVA: 0x0010B4B2 File Offset: 0x001096B2
		...
		// (get) Token: 0x06003A1B RID: 14875 RVA: 0x0010B4BA File Offset: 0x001096BA
		public object Value
		{
			get
			{
		...
		// Token: 0x06003A1C RID: 14876 RVA: 0x0010B4C2 File Offset: 0x001096C2
		static JsonReader()
		{
			JsonReader.PopulateParseTable();
		}

		// Token: 0x06003A1D RID: 14877 RVA: 0x0010B4C9 File Offset: 0x001096C9
		public JsonReader(string json_text) : this(new StringReader(json_text), true)
		{
		}

		// Token: 0x06003A1E RID: 14878 RVA: 0x0010B4D8 File Offset: 0x001096D8
		public JsonReader(TextReader reader) : this(reader, false)
		{
		}

		// Token: 0x06003A1F RID: 14879 RVA: 0x0010B4E4 File Offset: 0x001096E4
		...
		// Token: 0x06003A20 RID: 14880 RVA: 0x0010B570 File Offset: 0x00109770
		...
		// Token: 0x06003A21 RID: 14881 RVA: 0x0010B8E9 File Offset: 0x00109AE9
		private static void TableAddCol(ParserToken row, int col, params int[] symbols)
		{
			JsonReader.parse_table[(int)row].Add(col, symbols);
		}

		// Token: 0x06003A22 RID: 14882 RVA: 0x0010B8FD File Offset: 0x00109AFD
		private static void TableAddRow(ParserToken rule)
		{
			JsonReader.parse_table.Add((int)rule, new Dictionary<int, int[]>());
		}

		// Token: 0x06003A23 RID: 14883 RVA: 0x0010B910 File Offset: 0x00109B10
		...
		// Token: 0x06003A24 RID: 14884 RVA: 0x0010B9AC File Offset: 0x00109BAC
		...
		// Token: 0x06003A25 RID: 14885 RVA: 0x0010BB1E File Offset: 0x00109D1E
		...
		// Token: 0x06003A26 RID: 14886 RVA: 0x0010BB5D File Offset: 0x00109D5D
		public void Close()
		{
			if (this.end_of_input)
			{
		...
		// Token: 0x06003A27 RID: 14887 RVA: 0x0010BB90 File Offset: 0x00109D90
		public bool Read()
		{
			if (this.end_of_input)
			{
