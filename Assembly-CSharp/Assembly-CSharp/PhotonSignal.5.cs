...
public class PhotonSignal<T1, T2, T3, T4> : PhotonSignal
{
	...
	// (get) Token: 0x06003197 RID: 12695 RVA: 0x000EEE43 File Offset: 0x000ED043
	...
	// (add) Token: 0x06003198 RID: 12696 RVA: 0x000EEE46 File Offset: 0x000ED046
	// (remove) Token: 0x06003199 RID: 12697 RVA: 0x000EEE7A File Offset: 0x000ED07A
	...
	// Token: 0x0600319A RID: 12698 RVA: 0x000EE9F7 File Offset: 0x000ECBF7
	public PhotonSignal(string signalID) : base(signalID)
	{
	}

	// Token: 0x0600319B RID: 12699 RVA: 0x000EEA00 File Offset: 0x000ECC00
	public PhotonSignal(int signalID) : base(signalID)
	{
	}

	// Token: 0x0600319C RID: 12700 RVA: 0x000EEE97 File Offset: 0x000ED097
	...
	// Token: 0x0600319D RID: 12701 RVA: 0x000EEEA6 File Offset: 0x000ED0A6
	public void Raise(T1 arg1, T2 arg2, T3 arg3, T4 arg4)
	{
		this.Raise(this._receivers, arg1, arg2, arg3, arg4);
	}

	// Token: 0x0600319E RID: 12702 RVA: 0x000EEEBC File Offset: 0x000ED0BC
	...
	// Token: 0x0600319F RID: 12703 RVA: 0x000EEF78 File Offset: 0x000ED178
	...
	// Token: 0x060031A0 RID: 12704 RVA: 0x000EEFC0 File Offset: 0x000ED1C0
	public new static implicit operator PhotonSignal<T1, T2, T3, T4>(string s)
	{
		return new PhotonSignal<T1, T2, T3, T4>(s);
	}

	// Token: 0x060031A1 RID: 12705 RVA: 0x000EEFC8 File Offset: 0x000ED1C8
