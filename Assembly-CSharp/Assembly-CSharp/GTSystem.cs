...
public abstract class GTSystem<T> : MonoBehaviour, IReadOnlyList<T>, IEnumerable<T>, IEnumerable, IReadOnlyCollection<T> where T : MonoBehaviour
{
	...
	// (get) Token: 0x06002529 RID: 9513 RVA: 0x000B8822 File Offset: 0x000B6A22
	...
	// Token: 0x0600252A RID: 9514 RVA: 0x000B882A File Offset: 0x000B6A2A
	protected virtual void Awake()
	{
		GTSystem<T>.SetSingleton(this);
	}

	// Token: 0x0600252B RID: 9515 RVA: 0x000B8834 File Offset: 0x000B6A34
	...
	// Token: 0x0600252C RID: 9516 RVA: 0x000B887F File Offset: 0x000B6A7F
	protected virtual void OnApplicationQuit()
	{
		GTSystem<T>.gAppQuitting = true;
	}

	// Token: 0x0600252D RID: 9517 RVA: 0x000023F4 File Offset: 0x000005F4
	protected virtual void OnTick(float dt, T instance)
	{
	}

	// Token: 0x0600252E RID: 9518 RVA: 0x000B8888 File Offset: 0x000B6A88
	...
	// Token: 0x0600252F RID: 9519 RVA: 0x000023F4 File Offset: 0x000005F4
	protected virtual void OnRegister(T instance)
	{
	}

	// Token: 0x06002530 RID: 9520 RVA: 0x000B88EC File Offset: 0x000B6AEC
	...
	// Token: 0x06002531 RID: 9521 RVA: 0x000023F4 File Offset: 0x000005F4
	protected virtual void OnUnregister(T instance)
	{
	}

	// Token: 0x06002532 RID: 9522 RVA: 0x000B894E File Offset: 0x000B6B4E
	IEnumerator<T> IEnumerable<!0>.GetEnumerator()
	{
		return ((IEnumerable<!0>)this._instances).GetEnumerator();
	}

	// Token: 0x06002533 RID: 9523 RVA: 0x000B894E File Offset: 0x000B6B4E
	...
	// (get) Token: 0x06002534 RID: 9524 RVA: 0x000B895B File Offset: 0x000B6B5B
	...
	// (get) Token: 0x06002536 RID: 9526 RVA: 0x000B8976 File Offset: 0x000B6B76
	...
	// Token: 0x06002537 RID: 9527 RVA: 0x000B8984 File Offset: 0x000B6B84
	...
	// Token: 0x06002538 RID: 9528 RVA: 0x000B8A74 File Offset: 0x000B6C74
	...
	// Token: 0x06002539 RID: 9529 RVA: 0x000B8AE0 File Offset: 0x000B6CE0
