...
{
	// Token: 0x06001428 RID: 5160 RVA: 0x00062F03 File Offset: 0x00061103
	private void Start()
	{
		this.m_controller = ((this.m_handedness == OVRInput.Handedness.LeftHanded) ? OVRInput.Controller.LTouch : OVRInput.Controller.RTouch);
	}

	// Token: 0x06001429 RID: 5161 RVA: 0x00062F18 File Offset: 0x00061118
	private void Update()
	{
	...
	// Token: 0x0600142A RID: 5162 RVA: 0x00063117 File Offset: 0x00061317
	private static string ToDeviceModel()
	{
		return "Touch";
	}

	// Token: 0x0600142B RID: 5163 RVA: 0x0006311E File Offset: 0x0006131E
