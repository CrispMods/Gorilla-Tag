...
public class GorillaHandSocket : MonoBehaviour
{
	...
	// (get) Token: 0x06002212 RID: 8722 RVA: 0x000A8BA8 File Offset: 0x000A6DA8
	...
	// (get) Token: 0x06002213 RID: 8723 RVA: 0x000A8BB0 File Offset: 0x000A6DB0
	public bool inUse
	{
		get
		{
	...
	// Token: 0x06002214 RID: 8724 RVA: 0x000A8BB8 File Offset: 0x000A6DB8
	...
	// Token: 0x06002215 RID: 8725 RVA: 0x000A8BC6 File Offset: 0x000A6DC6
	public bool CanAttach()
	{
		return !this._inUse && this._sinceSocketStateChange.HasElapsed(this.attachCooldown, true);
	}

	// Token: 0x06002216 RID: 8726 RVA: 0x000A8BE4 File Offset: 0x000A6DE4
	...
	// Token: 0x06002217 RID: 8727 RVA: 0x000A8C14 File Offset: 0x000A6E14
	public void Detach()
	{
	...
	// Token: 0x06002218 RID: 8728 RVA: 0x000A8C2C File Offset: 0x000A6E2C
	...
	// Token: 0x06002219 RID: 8729 RVA: 0x000023F4 File Offset: 0x000005F4
	...
	// Token: 0x0600221B RID: 8731 RVA: 0x000A8C82 File Offset: 0x000A6E82
	protected virtual void OnUpdateAttached()
	{
		this._attachedHand.transform.position = base.transform.position;
	}

	// Token: 0x0600221C RID: 8732 RVA: 0x000A8C9F File Offset: 0x000A6E9F
	...
	// Token: 0x0600221D RID: 8733 RVA: 0x000A8CC2 File Offset: 0x000A6EC2
	...
	// Token: 0x0600221E RID: 8734 RVA: 0x000A8CE4 File Offset: 0x000A6EE4
	private void Awake()
	{
		this.Setup();
	}

	// Token: 0x0600221F RID: 8735 RVA: 0x000A8CEC File Offset: 0x000A6EEC
	...
	// Token: 0x06002220 RID: 8736 RVA: 0x000A8D0C File Offset: 0x000A6F0C
	private void Setup()
	{
		if (this.collider == null)
		{
