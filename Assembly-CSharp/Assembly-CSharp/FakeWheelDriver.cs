...
public class FakeWheelDriver : MonoBehaviour
{
	...
	// (get) Token: 0x060008B5 RID: 2229 RVA: 0x0002FAE5 File Offset: 0x0002DCE5
	// (set) Token: 0x060008B6 RID: 2230 RVA: 0x0002FAED File Offset: 0x0002DCED
	public bool hasCollision { get; private set; }

	// Token: 0x060008B7 RID: 2231 RVA: 0x0002FAF6 File Offset: 0x0002DCF6
	public void SetThrust(Vector3 thrust)
	{
		this.thrust = thrust;
	}

	// Token: 0x060008B8 RID: 2232 RVA: 0x0002FB00 File Offset: 0x0002DD00
	...
	// Token: 0x060008B9 RID: 2233 RVA: 0x0002FB8C File Offset: 0x0002DD8C
