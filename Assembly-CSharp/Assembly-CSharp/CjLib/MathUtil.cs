...
namespace CjLib
{
	...
	{
		// Token: 0x0600517C RID: 20860 RVA: 0x0018FD98 File Offset: 0x0018DF98
		public static float AsinSafe(float x)
		{
			return Mathf.Asin(Mathf.Clamp(x, -1f, 1f));
		}

		// Token: 0x0600517D RID: 20861 RVA: 0x0018FDAF File Offset: 0x0018DFAF
		public static float AcosSafe(float x)
		{
			return Mathf.Acos(Mathf.Clamp(x, -1f, 1f));
		}

		// Token: 0x0600517E RID: 20862 RVA: 0x0018FDC8 File Offset: 0x0018DFC8
