...
public class CrittersCageDeposit : CrittersActorDeposit
{
	...
	// (add) Token: 0x06000143 RID: 323 RVA: 0x00008D88 File Offset: 0x00006F88
	// (remove) Token: 0x06000144 RID: 324 RVA: 0x00008DC0 File Offset: 0x00006FC0
	public event Action<CrittersPawn, int> OnDepositCritter;

	// Token: 0x06000145 RID: 325 RVA: 0x00008DF5 File Offset: 0x00006FF5
	private void Awake()
	{
		this.attachPoint.OnGrabbedChild += this.StartProcessCage;
	}

	// Token: 0x06000146 RID: 326 RVA: 0x00008E0E File Offset: 0x0000700E
	protected override bool CanDeposit(CrittersActor depositActor)
	{
		return base.CanDeposit(depositActor) && !this.isHandlingDeposit;
	}

	// Token: 0x06000147 RID: 327 RVA: 0x00008E24 File Offset: 0x00007024
	...
	// Token: 0x06000148 RID: 328 RVA: 0x00008E3A File Offset: 0x0000703A
	...
	// Token: 0x06000149 RID: 329 RVA: 0x00008E4C File Offset: 0x0000704C
