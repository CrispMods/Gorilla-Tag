...
public class CrittersCageDeposit : CrittersActorDeposit
{
	...
	// (add) Token: 0x06000142 RID: 322 RVA: 0x00008B70 File Offset: 0x00006D70
	// (remove) Token: 0x06000143 RID: 323 RVA: 0x00008BA8 File Offset: 0x00006DA8
	public event Action<CrittersPawn, int> OnDepositCritter;

	// Token: 0x06000144 RID: 324 RVA: 0x00008BDD File Offset: 0x00006DDD
	private void Awake()
	{
		this.attachPoint.OnGrabbedChild += this.StartProcessCage;
	}

	// Token: 0x06000145 RID: 325 RVA: 0x00008BF6 File Offset: 0x00006DF6
	protected override bool CanDeposit(CrittersActor depositActor)
	{
		return base.CanDeposit(depositActor) && !this.isHandlingDeposit;
	}

	// Token: 0x06000146 RID: 326 RVA: 0x00008C0C File Offset: 0x00006E0C
	...
	// Token: 0x06000147 RID: 327 RVA: 0x00008C22 File Offset: 0x00006E22
	...
	// Token: 0x06000148 RID: 328 RVA: 0x00008C34 File Offset: 0x00006E34
