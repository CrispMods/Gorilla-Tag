...
public class EdibleHoldable : TransferrableObject
{
	...
	// (get) Token: 0x060017FB RID: 6139 RVA: 0x00074C02 File Offset: 0x00072E02
	// (set) Token: 0x060017FC RID: 6140 RVA: 0x00074C0A File Offset: 0x00072E0A
	public int lastBiterActorID { get; private set; } = -1;

	// Token: 0x060017FD RID: 6141 RVA: 0x00074C13 File Offset: 0x00072E13
	...
	// Token: 0x060017FE RID: 6142 RVA: 0x00074C48 File Offset: 0x00072E48
	...
	// Token: 0x060017FF RID: 6143 RVA: 0x00074C64 File Offset: 0x00072E64
	public override void OnActivate()
	{
		base.OnActivate();
	}

	// Token: 0x06001800 RID: 6144 RVA: 0x00074C6C File Offset: 0x00072E6C
	internal override void OnEnable()
	{
		base.OnEnable();
	}

	// Token: 0x06001801 RID: 6145 RVA: 0x0001FBE3 File Offset: 0x0001DDE3
	internal override void OnDisable()
	{
		base.OnDisable();
	}

	// Token: 0x06001802 RID: 6146 RVA: 0x00074C74 File Offset: 0x00072E74
	public override void ResetToDefaultState()
	{
		base.ResetToDefaultState();
	}

	// Token: 0x06001803 RID: 6147 RVA: 0x00074C7C File Offset: 0x00072E7C
	public override bool OnRelease(DropZone zoneReleased, GameObject releasingHand)
	{
		return base.OnRelease(zoneReleased, releasingHand) && !base.InHand();
	}

	// Token: 0x06001804 RID: 6148 RVA: 0x00074C98 File Offset: 0x00072E98
	...
	// Token: 0x06001805 RID: 6149 RVA: 0x00074F18 File Offset: 0x00073118
	...
	// Token: 0x06001806 RID: 6150 RVA: 0x00074F48 File Offset: 0x00073148
	...
	// Token: 0x06001807 RID: 6151 RVA: 0x000444E2 File Offset: 0x000426E2
	public override bool CanActivate()
	{
		return true;
	}

	// Token: 0x06001808 RID: 6152 RVA: 0x000444E2 File Offset: 0x000426E2
